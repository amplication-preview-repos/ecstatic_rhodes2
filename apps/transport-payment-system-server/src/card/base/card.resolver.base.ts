...
export class CardResolverBase {
  ...
  async createCard(@graphql.Args() args: CreateCardArgs): Promise<Card> {
    return await this.service.createCard({
      ...
      data: {
        ...
        commuter: args.data.commuter
          ? {
              connect: args.data.commuter,
            }
          : undefined,
      },
    });
  ...
  async getCommuter(@graphql.Parent() parent: Card): Promise<Commuter | null> {
    const result = await this.service.getCommuter(parent.id);
